...
export function checkCircleCollision(a: BaseEntity, b: BaseEntity): boolean {
  ...
  return distSq < minDist * minDist; // Evita sqrt desnecessário
}
...
//TODO: Verificar necessidade e viabilidade para Spatial Hashing em troca dessa bosta de O(n²)
export function processCollisions(entities: BaseEntity[]): void {
